...
var RequireReadTerms = /*#__PURE__*/function () {
  function RequireReadTerms() {
    ...
    _defineProperty(this, "haveAgreed", false);
  ...
  _createClass(RequireReadTerms, [{
    ...
    value: function eventListeners() {
      ...
      form.addEventListener("submit", this.catchFormSubmit); //catch button click to show modal

      this.termsButton.onclick = function () {
    ...
    value: function check() {
      return this.haveRead === true && this.haveAgreed === true;
    }
  }, {
    key: "remind",
    value: function remind() {
      this.showModal();
      return false;
    }
  }, {
